...
Assign HFNLF then make it randomly sample through the list for a fraction of .4 
Concatenate the list with 4LF presentations and one HF presentation 
Sample through this entire list by using 100% or frac=1 which means that LF will be presented 40 times and HF will be presented 10 times resulting in a total of 50 trials 
...
Wait for 500 ms
Store response, reaction time and correct response
